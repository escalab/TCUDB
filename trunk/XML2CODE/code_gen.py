...
################# end of reading the needed attributes of fact table from disk ###############
        ...
        factName = resName
        # NOTE: consecutive calls to hashJoin
        ...
        print >>fo, "\t\t" + factName + "->tupleNum = header.tupleNum;"
        #FIXME: determine msplitm or regular denseMM
        # cannot get tupleNum at this point
        # read(outFd, &header, sizeof(struct columnHeader)); // when driver read from binary header
          ...
          #  print >>fo, "\t\t" + "printf(lOut:" + str(lOutLen)+ " rOut:" + str(rOutLen) + ");"
            ...
            if joinType == 2:
                ...
                if (i == len(joinAttr.dimTables)-1 and len(aggNode) > 0):
                    ...
                    #Note: determine whether groupBy on left/right table
            ...
            #FIXME: whether to call blockGEMMKernel or tcuJoin depending on data size
            if CODETYPE == 0: # CUDA
