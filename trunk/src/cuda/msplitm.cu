...
/*  Use CUBLAS_COMPUTE_32F_FAST_16F flag to use Tensor Cores 
    with automatic down-conversion and 16-bit half-precision compute 
    for 32-bit input and output matrices */
float * doHalfMultiply2MatricesStreaming(
        int a1Rows, int a1Cols, float * A1,
        int a2Rows, int a2Cols, float * A2,
        ...
        float alpha)
{
    ...
    cublasStatus_t stat = cublasGemmEx(handle,
                  ...
                  a2Cols, a1Rows, a1Cols,
                  &alpha,
                  A2, CUDA_R_16F, a2Cols,
                  A1, CUDA_R_16F, a1Cols,
                  &beta,
                  C, CUDA_R_32F, a2Cols,
